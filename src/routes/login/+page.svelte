		...
		<div class="header-content">
			...
			<div class="header-actions">
				<div class="auth-badge">
					<span class="text-caption text-gray-600">Sign In</span>
				</div>
			</div>
		</div>
	</header>
	...
	<main class="auth-main">
		<div class="auth-card glass-card animate-entrance animate-entrance-delay-2" class:mounted>
			...
			<div class="form-header">
				<h2 class="text-heading-2 text-gray-800">Welcome Back</h2>
				<p class="text-body text-gray-600">Sign in to your PlantCam dashboard</p>
			</div>
				...
				>
					{#if isLoading}
						<div class="loading-spinner">
							...
							<span class="text-body">Signing in...</span>
						</div>
					{:else}
						<span class="text-body">Sign In</span>
					{/if}
				</button>
			</form>
			...
			<div class="auth-navigation">
				<p class="text-body-small text-gray-600">
					...
					<a href="/signup" class="auth-link text-gradient-nature animate-hover-scale">
						Sign up here
					</a>
				</p>
			</div>
